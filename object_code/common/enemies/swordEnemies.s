...
@ngpEnemy3DUpgradeSubtable2:
	...
	@ngpEnemy3DRedUpgrades1:
		; 06 03
		m_ngp_upgrade_p_si_d_h_s		PALETTE_RED   0 08 04 SPEED_a0
	@ngpEnemy3DRedUpgrades2:
		m_ngp_upgrade_p_si_d_h_s		PALETTE_RED   0 08 04 SPEED_a0
	@ngpEnemy3DBlueSlowUpgrades:
		; 06 05
		m_ngp_upgrade_p_si_d_h_s		PALETTE_BLUE  1 08 07 SPEED_c0
	@ngpEnemy3DBlueFastUpgrades:
		m_ngp_upgrade_p_si_d_h_s		PALETTE_BLUE  2 08 07 SPEED_c0
		m_ngp_upgrade_p_si_d_h_s_term	PALETTE_GREEN 2 10 10 SPEED_e0
...
@ngpEnemy48UpgradeSubtable2:
	...
	@ngpEnemy48RedUpgrades1:
		; 04 06
		m_ngp_upgrade_p_si_d_h_s		PALETTE_RED   0 06 08 SPEED_a0
	@ngpEnemy48RedUpgrades2:
		m_ngp_upgrade_p_si_d_h_s		PALETTE_RED   0 06 08 SPEED_a0
	@ngpEnemy48BlueUpgrades:
		; 08 09
		m_ngp_upgrade_p_si_d_h_s		PALETTE_BLUE  1 12 11 SPEED_c0
		m_ngp_upgrade_p_si_d_h_s		PALETTE_BLUE  1 12 11 SPEED_c0
...
@ngpEnemy49UpgradeSubtable2:
	...
	@ngpEnemy49SlowUpgrades1:
		; 04 04
		m_ngp_upgrade_p_si_d_h_s		PALETTE_GREEN 0 06 06 SPEED_a0
	...
	@ngpEnemy49FastestUpgrades:
		; 04 04
		m_ngp_upgrade_p_si_d_h_s_term	PALETTE_RED   2 08 08 SPEED_c0
...
@ngpEnemy4AUpgradeSubtable2:
	...
	@ngpEnemy4ARedUpgrades1:
		; 04 02
		m_ngp_upgrade_p_si_d_h_s		PALETTE_RED   0 06 03 SPEED_a0
	...
	@ngpEnemy4ABlueFastUpgrades:
		m_ngp_upgrade_p_si_d_h_s		PALETTE_BLUE  2 06 05 SPEED_c0
		m_ngp_upgrade_p_si_d_h_s_term	PALETTE_GREEN 2 08 08 SPEED_c0
.else
