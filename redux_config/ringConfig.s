...
.ifdef REMAP_RING_LIST
	...
	;       These MUST contain exactly 64 items and MUST NOT contain duplicates.
	m_RingListRow	POWER_RING_L1		POWER_RING_L2		POWER_RING_L3		RED_RING
	m_RingListRow	GREEN_RING			GREEN_HOLY_RING		RED_HOLY_RING		BLUE_HOLY_RING
	m_RingListRow	ARMOR_RING_L1		ARMOR_RING_L2		ARMOR_RING_L3		BLUE_RING
	m_RingListRow	GOLD_RING			GREEN_LUCK_RING		RED_LUCK_RING		BLUE_LUCK_RING

	m_RingListRow	HEART_RING_L1		RANG_RING_L1		FIST_RING			LIGHT_RING_L1
	m_RingListRow	ENERGY_RING			SPIN_RING			CHARGE_RING			VICTORY_RING
	m_RingListRow	HEART_RING_L2		RANG_RING_L2		EXPERTS_RING		LIGHT_RING_L2
	m_RingListRow	BLAST_RING			PEACE_RING			BOMBPROOF_RING		BOMBERS_RING

	m_RingListRow	HASTE_RING			HIKERS_RING			ZORA_SCALE_RING		BUCKLER_RING
	m_RingListRow	GREEN_JOY_RING		RED_JOY_RING		BLUE_JOY_RING		GOLD_JOY_RING
	m_RingListRow	STEADFAST_RING		MYSTIC_SEED_RING	TOSS_RING			ROCS_RING
	m_RingListRow	FARMERS_RING		ALCHEMY_RING		DISCOVERY_RING		AZUCHU_RING

	m_RingListRow	GREEN_COLOR_RING	RED_COLOR_RING		BLUE_COLOR_RING		GOLD_COLOR_RING
