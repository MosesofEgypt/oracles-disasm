...
ifdef ORACLE_GASHA_REBALANCE
	DEFINES += -D ENABLE_GASHA_REBALANCE

ifndef ORACLE_RING_TIER_3_MAX_KILLS
	ORACLE_RING_TIER_3_MAX_KILLS = 70
endif
ifndef ORACLE_RING_TIER_2_MAX_KILLS
	ORACLE_RING_TIER_2_MAX_KILLS = 90
endif
ifndef ORACLE_RING_TIER_1_MAX_KILLS
	ORACLE_RING_TIER_1_MAX_KILLS = 110
endif
ifndef ORACLE_RING_TIER_2_MIN_KILLS
	ORACLE_RING_TIER_2_MIN_KILLS = 45
endif
ifndef ORACLE_RING_TIER_1_MIN_KILLS
	ORACLE_RING_TIER_1_MIN_KILLS = 50
endif
ifndef ORACLE_RING_TIER_0_MIN_KILLS
	ORACLE_RING_TIER_0_MIN_KILLS = 55
endif

	DEFINES += -D RING_TIER_3_MAX_KILLS=$(ORACLE_RING_TIER_3_MAX_KILLS)
	DEFINES += -D RING_TIER_2_MAX_KILLS=$(ORACLE_RING_TIER_2_MAX_KILLS)
	DEFINES += -D RING_TIER_1_MAX_KILLS=$(ORACLE_RING_TIER_1_MAX_KILLS)
	DEFINES += -D RING_TIER_2_MIN_KILLS=$(ORACLE_RING_TIER_2_MIN_KILLS)
	DEFINES += -D RING_TIER_1_MIN_KILLS=$(ORACLE_RING_TIER_1_MIN_KILLS)
	DEFINES += -D RING_TIER_0_MIN_KILLS=$(ORACLE_RING_TIER_0_MIN_KILLS)
endif

ifdef ORACLE_RING_BOX_RESIZE
ifdef ORACLE_RING_BOX_EXTEND
	MAX_RING_BOX_SIZE = 10
	DEFINES += -D EXTENDED_RING_BOX
else
	MAX_RING_BOX_SIZE = 5
endif

ifndef ORACLE_RING_BOX_PORTAL_LEVEL
	ORACLE_RING_BOX_PORTAL_LEVEL = 3
endif
ifndef ORACLE_RING_BOX_L1_SIZE
	ORACLE_RING_BOX_L1_SIZE = 1
endif
ifndef ORACLE_RING_BOX_L2_SIZE
	ORACLE_RING_BOX_L2_SIZE = 3
endif
ifndef ORACLE_RING_BOX_L3_SIZE
	ORACLE_RING_BOX_L3_SIZE = 5
endif

ifeq ($(shell test $(ORACLE_RING_BOX_L1_SIZE) -gt $(MAX_RING_BOX_SIZE); echo $$?),0)
	ORACLE_RING_BOX_L1_SIZE = $(ORACLE_MAX_RING_BOX_SIZE)
endif

ifeq ($(shell test $(ORACLE_RING_BOX_L2_SIZE) -gt $(MAX_RING_BOX_SIZE); echo $$?),0)
	ORACLE_RING_BOX_L2_SIZE = $(ORACLE_MAX_RING_BOX_SIZE)
endif

ifeq ($(shell test $(ORACLE_RING_BOX_L3_SIZE) -gt $(MAX_RING_BOX_SIZE); echo $$?),0)
	ORACLE_RING_BOX_L3_SIZE = $(ORACLE_MAX_RING_BOX_SIZE)
endif

# Due to how the ui works, the last ring box doesnt have any
# tiles cleared, so it must always contain at least 5 rings
ifeq ($(shell test $(ORACLE_RING_BOX_L3_SIZE) -lt 5; echo $$?),0)
	ORACLE_RING_BOX_L3_SIZE = 5
endif

	RING_BOX_L1_WIDTH = $(ORACLE_RING_BOX_L1_SIZE)
	RING_BOX_L2_WIDTH = $(ORACLE_RING_BOX_L2_SIZE)

ifeq ($(shell test $(RING_BOX_L1_WIDTH) -gt 5; echo $$?),0)
	RING_BOX_L1_WIDTH = 5
endif

ifeq ($(shell test $(RING_BOX_L2_WIDTH) -gt 5; echo $$?),0)
	RING_BOX_L2_WIDTH = 5
endif

	DEFINES += -D RING_BOX_L1_SIZE=$(ORACLE_RING_BOX_L1_SIZE)
	DEFINES += -D RING_BOX_L2_SIZE=$(ORACLE_RING_BOX_L2_SIZE)
	DEFINES += -D RING_BOX_L3_SIZE=$(ORACLE_RING_BOX_L3_SIZE)
	DEFINES += -D RING_BOX_L1_WIDTH=$(RING_BOX_L1_WIDTH)
	DEFINES += -D RING_BOX_L2_WIDTH=$(RING_BOX_L2_WIDTH)
	DEFINES += -D RING_BOX_PORTAL_LEVEL=$(ORACLE_RING_BOX_PORTAL_LEVEL)
endif
