...
@pogoTargets:
	...
	; 0x08-0x0f:
	; 0x10-0x17:
	; 0x18-0x1f: OCTOROK_PROJECTILE, ENEMY_ARROW, STALFOS_BONE, ENEMY_SWORD, 
	;            DEKU_SCRUB_PROJECTILE
	; 0x20-0x27: MOBLIN_BOOMERANG
	; 0x28-0x2f: SPIKED_BALL
	; 0x30-0x37: SUBTERROR_DIRT(ages), RAMROCK_GLOVE_FORM_ARM(ages), 
	;            PART_POPPABLE_BUBBLE(seasons), PART_STUB_35(seasons),
	; 0x38-0x3f: PART_38(seasons), PART_BALL(ages)
	; 0x40-0x47: PART_47(seasons), PART_BOMB(ages)
	; 0x48-0x4f: PART_DIN_CRYSTAL(seasons), PART_RAMROCK_SEED_FORM_ORB(ages)
	...
	dbrev %00100100 %10000000 ; 0x30-0x3f
