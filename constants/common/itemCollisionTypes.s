...
.if defined(ROM_COMBO)
	ITEMCOLLISION_ROD_OF_SEASONS_S	.db
	ITEMCOLLISION_SHOVEL_A			db ; $0c

	ITEMCOLLISION_SHOVEL_S			.db
	ITEMCOLLISION_SWITCH_HOOK_A		db ; $0d

	ITEMCOLLISION_SWITCH_HOOK_S		.db
...
.if defined(ROM_COMBO)
	ITEMCOLLISION_SOMARIA_BLOCK_S		.db
	ITEMCOLLISION_L2_BOOMERANG_A		db ; $13

	ITEMCOLLISION_THROWN_OBJECT_S		.db
	ITEMCOLLISION_ROD_OF_SEASONS_A		db ; $14

	ITEMCOLLISION_L1_BOOMERANG_S		.db
	ITEMCOLLISION_SOMARIA_BLOCK_A		db ; $15

	ITEMCOLLISION_L2_BOOMERANG_S		.db
	ITEMCOLLISION_THROWN_OBJECT_A		db ; $16

	ITEMCOLLISION_BOMB_S				.db
	ITEMCOLLISION_L1_BOOMERANG_A		db ; $17

	ITEMCOLLISION_MAGNET_BALL			.db
	ITEMCOLLISION_BOMB_A				db ; $18
.elif defined(ROM_AGES)
